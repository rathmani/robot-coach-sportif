...
static const _ExerciseConditions_type_support_symbol_names_t _ExerciseConditions_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, coach_interfaces, msg, ExerciseConditions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, coach_interfaces, msg, ExerciseConditions)),
  }
};
...
{
  return &::coach_interfaces::msg::rosidl_typesupport_cpp::ExerciseConditions_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, coach_interfaces, msg, ExerciseConditions)() {
  return get_message_type_support_handle<coach_interfaces::msg::ExerciseConditions>();
}
